...
class AddReferralViewModel(application: Application, private val state: SavedStateHandle) :
    ...
    private fun fetchQuestionnaireJson(): String {
        ...
        _questionnaireJson =
            getApplication<Application>()
                .readFileFromAssets(state[AddReferralFragment.QUESTIONNAIRE_FILE_PATH_KEY]!!)
